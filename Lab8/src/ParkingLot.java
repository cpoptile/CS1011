...
public class ParkingLot {
    ...
    public void displayStatus() {
        if (isClosed()) {
            ...
            System.out.println(name + " parking lot status: " + getPercentFull() + " %");
        }
    }
    ...
    public double getPercentFull() {
        double percent = ((double) (capacity - getNumberOfSpotsRemaining()) / (double) capacity) * 100;
        percent = new Double(df.format(percent));
        return percent;
    }
